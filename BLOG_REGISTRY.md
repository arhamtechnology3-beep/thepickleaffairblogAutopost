# BLOG_REGISTRY.md — Kitchen Tales source of truth

Policy: `BLOG.md` · Updated: 2026-09-20  
Blog: https://thepickleaffair.com/blogs/kitchen-tales

## Keyword / topic ownership

| Topic / primary keyword | Canonical URL | Cluster | Intent | Status |
|---|---|---|---|---|
| Sweet mango pickle / Meethi Keri | /blogs/kitchen-tales/sweet-mango-pickle-homemade-guide-the-pickle-affair | Heritage Recipes | Informational + commercial | KEEP / UPDATE |
| Katka Keri storage & serve | /blogs/kitchen-tales/katka-keri-pickle-how-to-store-and-serve-at-home-the-pickle-affair | How-to | How-to | KEEP / UPDATE |
| Buy Gunda Keri online | /blogs/kitchen-tales/buy-gunda-keri-online-guide-the-pickle-affair-20-sep | Buying Guides | Transactional | KEEP / UPDATE |
| Gujarati Keri Achar | /blogs/kitchen-tales/gujarati-keri-achar-guide-the-pickle-affair-20-sep | Heritage Recipes | Heritage + commercial | KEEP / UPDATE |
| Chana Keri Methi | /blogs/kitchen-tales/chana-keri-methi-pickle-guide-the-pickle-affair-20-sep | Health & Spices | Ingredient + commercial | KEEP / UPDATE |
| Ultimate Guide to Gujarati Pickles | *(not published)* | Pillar | Informational | IDEA |
| Chhundo vs Meethi Keri | *(not published)* | Comparison | Comparison | IDEA |
| How to store Indian pickles | *(not published)* | Pickle Guides | How-to | IDEA |
| How long does mango pickle last | *(not published)* | Pickle Guides | Informational | IDEA |
| Baa’s Kitchen / traditional making | *(not published)* | Artisanal Craft | Heritage | IDEA |
